...
\restrict 1cJBtNPVYKxl27G6rdigGQaIxrMKn3zsxLWmYhCGjA9oiIte5cZboqHvWJXL2K7
...
--
-- Name: vueschiensvendusen2023; Type: VIEW; Schema: public; Owner: daniel
--

CREATE VIEW public.vueschiensvendusen2023 AS
 SELECT nomchien,
    datevente,
    prixvente
   FROM public.chiens
  WHERE ((datevente >= '2023-01-01'::date) AND (datevente <= '2023-12-31'::date));


ALTER VIEW public.vueschiensvendusen2023 OWNER TO daniel;
...
1	Wouf	5	t	55260	2021-09-24	Blanc	1	980	2023-08-25	2025-12-07 22:05:36.571862
\.
...
SELECT pg_catalog.setval('public.chiens_idchien_seq', 22, true);
...
GRANT SELECT ON TABLE public.chiens TO antoine;
...
--
-- Name: TABLE vueschiensvendusen2023; Type: ACL; Schema: public; Owner: daniel
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.vueschiensvendusen2023 TO data_engineer;
...
\unrestrict 1cJBtNPVYKxl27G6rdigGQaIxrMKn3zsxLWmYhCGjA9oiIte5cZboqHvWJXL2K7
